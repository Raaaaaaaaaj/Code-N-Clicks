...
export const team: TeamMember[] = [
  {
    ...
    bio: "Avijit is a 23-year-old tech visionary obsessed with the intersection of clean code and commercial growth. By trading the traditional path for a seat at the head of the table, he founded Code n Clicks to level the playing field for businesses of all sizes through high-end technology."
    // image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop&crop=face",
  },
  {
    name: "Annwesha Banik",
    role: "Co-Founder & Technical Lead",
    bio: "Annwesha is a technical architect who believes great code should solve real-world problems. As Co-Founder, she bridges the gap between high-performance engineering and elegant design, ensuring every solution is as robust as it is intuitive. Driven by the mission to make elite tech accessible to every business"
