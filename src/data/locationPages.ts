...
export const cities: CityProfile[] = [
  {
    ...
    sectionOrder: ["hero", "ecosystem", "challenges", "services", "strategy", "deliverables", "faqs", "cta"],
  ...
  },
  {
    ...
    sectionOrder: ["hero", "ecosystem", "services", "challenges", "strategy", "deliverables", "faqs", "cta"],
    ...
    process: [
      ...
      { title: "Security Coding", desc: "Row-level security database setups to ensure strict data privacy." },
  ...
  },
  {
    ...
    sectionOrder: ["hero", "challenges", "ecosystem", "services", "strategy", "deliverables", "faqs", "cta"],
  ...
  },
  {
    ...
    sectionOrder: ["hero", "ecosystem", "strategy", "services", "challenges", "deliverables", "faqs", "cta"],
  ...
  },
  {
    ...
    sectionOrder: ["hero", "ecosystem", "challenges", "services", "strategy", "faqs", "cta"],
  ...
  },
  {
    ...
    sectionOrder: ["hero", "ecosystem", "challenges", "strategy", "services", "deliverables", "faqs", "cta"],
  ...
  },
  {
    ...
    sectionOrder: ["hero", "ecosystem", "services", "challenges", "strategy", "faqs", "cta"],
  ...
  },
  {
    ...
    sectionOrder: ["hero", "challenges", "ecosystem", "services", "strategy", "faqs", "cta"],
  ...
  },
  {
    ...
    sectionOrder: ["hero", "ecosystem", "services", "challenges", "strategy", "faqs", "cta"],
    ecosystemTitle: "Digitizing Chien Embroidery Trade & Boutique Hospitality Stays",
  ...
  },
  {
    ...
    ecosystemText: "Visakhapatnam is a port city with maritime trade networks, chemical SEZs in Sheela Nagar, and emerging IT hubs in Madhurawada. Teams require custom database systems, shipping track trackers, and cargo billing systems.",
