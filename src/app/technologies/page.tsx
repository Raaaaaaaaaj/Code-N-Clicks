          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-base md:text-lg  text-brand-graphite/80 leading-relaxed font-sans max-w-xl">
                We choose the right technologies for your product based on
                performance, scalability, integrations, security, and long-term
                maintainability—not simply what&apos;s trending.
              </p>
              <div className="pt-2">
                <Link
                  href="/contact"
            ...
            <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[420px] bg-brand-graphite text-white rounded-[32px] border-4 border-brand-graphite shadow-flat overflow-hidden p-6 aspect-[4/3] flex flex-col justify-between font-mono text-xs sm:text-sm">
                ...
                <div className="text-white/40">
                  // Enterprise-grade software foundations.
                </div>

                <div className="space-y-1">
                  <div>
                    <span className="text-brand-blue">const</span>{" "}
                    <span className="text-white">frontend</span> <span>=</span>{" "}
                    <span className="text-brand-lime">
                      &quot;Next.js + React&quot;
                    </span>
                    ;
                  ...
                  <div>
                    <span className="text-brand-blue">const</span>{" "}
                    <span className="text-white">backend</span> <span>=</span>{" "}
                    <span className="text-brand-lime">
                      &quot;Node.js + Python&quot;
                    </span>
                    ;
                  ...
                  <div>
                    <span className="text-brand-blue">const</span>{" "}
                    <span className="text-white">database</span> <span>=</span>{" "}
                    <span className="text-brand-lime">
                      &quot;PostgreSQL + Redis&quot;
                    </span>
                    ;
                  ...
                  <div>
                    <span className="text-brand-blue">const</span>{" "}
                    <span className="text-white">cloud</span> <span>=</span>{" "}
                    <span className="text-brand-lime">
                      &quot;AWS + Docker&quot;
                    </span>
                    ;
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="space-y-6 text-base text-brand-graphite/85 leading-relaxed font-sans border-l-4 border-brand-blue pl-6 md:pl-8 py-2">
              <p>
                There is no single best technology stack for every software
                product. A marketing website, SaaS platform, enterprise
                application, AI product, and high-traffic eCommerce platform can
                have very different technical requirements.
              </p>
              <p>
                At Code N Clicks, we select technologies around your
                product&apos;s architecture, expected scale, integrations,
                development speed, and long-term maintenance requirements. Our
                stack covers modern frontend frameworks, backend platforms,
                databases, cloud infrastructure, DevOps, AI, analytics, and
                product design tools.
              </p>
              <p className="font-semibold text-brand-graphite">
                Whether you&apos;re building an MVP or modernizing an existing
                application, we focus on creating a technology foundation that
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="max-w-3xl mb-12 space-y-4">
            ...
            <p className="text-brand-graphite/70 font-sans leading-relaxed">
              Technology selection depends on your workload, team skills, and
              architecture requirements. Below is a guidance matrix of stack
              combinations we may consider for your product.
            </p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-brand-graphite text-white font-mono text-xs uppercase tracking-wider">
                  <th className="py-5 px-6 border-b border-brand-graphite w-2/5 font-bold">
                    Product Requirement
                  </th>
                  <th className="py-5 px-6 border-b border-brand-graphite w-3/5 font-bold">
              ...
              <tbody className="divide-y-2 divide-brand-graphite/10 font-sans">
                {selectionMatrix.map((row, i) => (
                  <tr
                    key={row.requirement}
                    className={i % 2 === 0 ? "bg-white" : "bg-brand-mist/40"}
                  >
          ...
          <div className="max-w-4xl mx-auto p-8 md:p-12 bg-brand-mist/60 border-2 border-brand-graphite rounded-[32px] shadow-premium relative overflow-hidden">
            ...
            <div className="space-y-6 relative z-10">
              ...
              <div className="space-y-4 text-base text-brand-graphite/80 leading-relaxed font-sans">
                <p>
                  Technology should support your business—not dictate how your
                  business operates.
                </p>
                <p>
                  Whether you&apos;re launching a new SaaS product, building a
                  customer-facing web application, modernizing a legacy system,
                  or adding AI to an existing platform, our engineers evaluate
                  the technical requirements before recommending the stack.
                </p>
                <p className="font-semibold text-brand-graphite">
                  We combine frontend frameworks, backend technologies,
                  databases, cloud infrastructure, DevOps, AI, analytics, and
                  design tools to create software that is practical to build
                  today and easier to maintain tomorrow.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-brand-blue text-white py-24 text-center">
        <div className="container mx-auto px-4 lg:px-8 space-y-6">
          ...
          <p className="text-white/80 max-w-xl mx-auto text-base leading-relaxed font-sans">
            Let&apos;s discuss your product requirements and identify a
            technology foundation built for performance, scalability, and
            long-term growth.
          </p>
          <div className="pt-4">
            <Link
