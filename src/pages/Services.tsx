        ...
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              From concept to deployment and beyond — we offer a full spectrum of digital services designed to accelerate your business growth.
            </p>
          </motion.div>
        </div>
      </section>
              ...
              return (
                ...
                >
                  <Link
                    ...
                    className="block h-full p-8 bg-card-gradient border border-border rounded-xl hover-lift group"
                  >
